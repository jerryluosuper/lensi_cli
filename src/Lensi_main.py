...
def GUL_search(ui):
    ...
    app_num = [1,1,1,1,1]
    result = Lensi_CLI.Lensi_search(app_name,app_num)
    # print(result)
    #摆烂做法 ！！ 开摆了 (╯▔皿▔)╯
    try:
...
def GUL_install_1(ui):
    ...
    Lensi_CLI.Lensi_install(app_name,app_source)
...
if __name__ == '__main__':
    ...
    MainWindow.show()
    ui.pushButton_2.clicked.connect(Lensi_CLI.Lensi_init)
    ui.pushButton_3.clicked.connect(Lensi_CLI.Lensi_update_all)
